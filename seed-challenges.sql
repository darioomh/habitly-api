...
-- 2. Maratón de Productividad (SOLO PREMIUM)
INSERT INTO challenges (title, description, category, difficulty, duration_days, max_participants, reward, is_public, is_premium_required, start_date)
VALUES (
...
-- 6. Comparte la App con tus Contactos
INSERT INTO challenges (title, description, category, difficulty, duration_days, max_participants, reward, is_public, is_premium_required, start_date)
VALUES (
    'Comparte la App con tus Contactos',
    'Invita a 10 amigos a usar Habitly. Comparte el enlace y gana 1 mes Premium gratis.',
    'SOCIAL',
    'easy',
    30,
    9999,
